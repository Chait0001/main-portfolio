...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Construct mailto link as a simple send mechanism
    const mailtoLink = `mailto:chaitanyakumar6786@gmail.com?subject=${encodeURIComponent(formData.subject || 'Portfolio Contact')}&body=${encodeURIComponent(
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Chait0001',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/chaitanya-kumar-923387308/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LeetCode',
      url: 'https://leetcode.com/u/Chaitanya_6786/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <p className="text-white/40 text-base mb-8 font-light leading-relaxed">
              ...
              <br />
              I don't bite. Worst case, I'll send you a meme.
            </p>

            <a 
              href="mailto:chaitanyakumar6786@gmail.com"
              className="inline-block text-white/70 text-sm font-mono mb-8 hover:text-white transition-colors duration-200"
            >
              chaitanyakumar6786@gmail.com
            </a>
